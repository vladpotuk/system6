...
namespace WpfApp1
{
    public partial class MainWindow : Window
    {
        ...
        private void StartCopy_Click(object sender, RoutedEventArgs e)
        {
            ...
            Thread copyThread = new Thread(() => CopyFile(sourcePath, destinationPath, numThreads));
            copyThread.Start();
        }
        ...
        private void CopyPart(object state)
        {
            ...
            long bytesCopied = 0;
            while (bytesCopied < size && (bytesRead = sourceStream.Read(buffer, 0, buffer.Length)) > 0)
            {
